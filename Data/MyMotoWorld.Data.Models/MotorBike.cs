...
using MyMotoWorld.Models.ClientModels;
...
namespace MyMotoWorld.Models
{
    public class MotorBike
    {
        public MotorBike()
        {
            ...
            this.MotorBikeOrders = new HashSet<MotorBikeOrders>();
        }
        ...
        public virtual ICollection<MotorBikeOrders> MotorBikeOrders { get; set; }
    }
}
